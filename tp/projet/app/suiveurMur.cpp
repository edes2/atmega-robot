...
SuiveurMur::SuiveurMur(CapteurIR* capteurIR, ChauffeurDuRobot* chauffeur)  : capteurIR_(capteurIR), margueriteMur_(chauffeur)
{
...
{
    margueriteMur_->virage(calculerRoueGauche(), calculerRoueDroite());
}